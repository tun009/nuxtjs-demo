<template>
  <div v-if="show" class="fixed inset-0 z-50 overflow-y-auto">
    ...
    >
      <div
        class="relative transform overflow-hidden rounded-lg bg-gradient-to-br from-gray-800/90 to-gray-900/90 border border-gray-700/50 backdrop-blur-lg px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl sm:p-6"
      >
        <!-- Close Button -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div v-for="pkg in packages" :key="pkg.id" class="relative group">
            ...
            <!-- Package Content -->
            <div
              class="relative p-6 rounded-xl bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 group-hover:border-primary-500/50 transition-all duration-300"
            >
              <!-- Package Name -->
              ...
              <ul class="space-y-3 mb-6">
                <li class="flex items-center text-gray-300">
                  <Icon
                    ...
                    class="w-5 h-5 text-primary-400 mr-2"
                  />
              ...
              <button
                ...
                class="w-full px-4 py-2 bg-primary-500 hover:bg-primary-400 disabled:bg-gray-600 text-white rounded-lg transform hover:-translate-y-1 transition-all duration-200 shadow-[0_0_15px_rgba(0,115,245,0.5)] hover:shadow-[0_0_25px_rgba(0,115,245,0.8)] disabled:transform-none disabled:shadow-none"
              >
                {{
