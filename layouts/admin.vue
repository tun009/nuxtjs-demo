  ...
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
    ...
    >
      ...
      <div class="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-gray-700">
        <NuxtLink to="/admin" class="flex items-center space-x-2 text-blue-600 dark:text-blue-400">
        ...
        <div class="ml-auto flex items-center space-x-4">
          ...
          <div class="relative" ref="notificationsRef">
            ...
            >
              ...
              <div class="max-h-60 overflow-y-auto">
                ...
                <div v-if="notifications.length === 0" class="px-4 py-2 text-center text-sm text-gray-500 dark:text-gray-400">
                  No notifications
                </div>
              </div>
              
              <div class="border-t border-gray-200 dark:border-gray-700 px-4 py-2 text-center">
                <NuxtLink to="/admin/notifications" class="text-xs text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">
          ...
          <div class="relative" ref="userMenuRef">
            ...
            >
              ...
              <span class="hidden md:inline-block">{{ currentUser?.name || 'Admin' }}</span>
            ...
            >
              <div class="px-4 py-2 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="text-xs text-gray-500 dark:text-gray-400">{{ currentUser?.email || 'admin@example.com' }}</div>
              </div>
              
              <NuxtLink to="/admin/profile" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                Your Profile
              </NuxtLink>
              <NuxtLink to="/admin/settings" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                Settings
              </NuxtLink>
